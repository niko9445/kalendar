...
const Goals: React.FC = () => {
  ...
  const { t, goals: goalsT } = useTranslation(); // ИСПОЛЬЗУЕМ ПЕРЕВОДЫ
  ...
  return (
    <div className="min-h-screen bg-background dark:bg-dark-background pb-20 transition-colors duration-200">
      ...
      <Header 
        title={goalsT('title')} // ИСПОЛЬЗУЕМ ПЕРЕВОД
        subtitle={t('goals.activeGoals', { count: goals.length })} // ИСПОЛЬЗУЕМ ПЕРЕВОД С ПАРАМЕТРОМ
        rightAction={
          <button
